...
\subsection{Первый эксперимент}\label{subsec:-2}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.8\linewidth]{Python/first-exp}
...
\subsection{Сравнение с Гамма-распределением}\label{subsec:---}
